...
struct PlanTrainingSheet: View {
    ...
    private var noteTrimmed: String { note.trimmingCharacters(in: .whitespaces) }
    ...
    private func accentForKind(_ k: TrainingSessionType) -> Color {
        ...
        @unknown default: return TrainingBrand.stats
        }
    }
